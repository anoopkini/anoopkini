    ...
    <>
      ...
      <section className="hero hero-content min-h-screen flex flex-col">
        ...
        <div className="max-w-lg text-center">
          <p className="inline">I am <span className="bg-amber-200 p-1">Anoop Kini</span>, Product Manager @ <a target="_blank" href="https://www.ericsson.com/en">Ericsson.</a></p>
          <br />
